...
//    public static final String SAVETOPHOTOPATH = "/storage/emulated/0/DCIM/Camera/";//保存至本地相册路径
    public static final String SAVETOPHOTOPATH = "/storage/emulated/0/HuaiYuan/cameratemp/";
    public static final String ISSAVEVIDEOTEMPEXIST = "/storage/emulated/0/HuaiYuan/videotemp/";
    public static final String VIDEOTEMP = "/storage/emulated/0/HuaiYuan/videotemp/";
