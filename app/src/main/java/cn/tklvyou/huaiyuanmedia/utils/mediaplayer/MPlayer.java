...
public class MPlayer implements IMPlayer, MediaPlayer.OnBufferingUpdateListener,
    ...
    private IMPlayStatusListener mPlayStatusListener;
    ...
    private void playStart(){
        if(isVideoSizeMeasured&&isMediaPrepared&&isSurfaceCreated&&isUserWantToPlay){
    ...
    public void setPlayStatusListener(IMPlayStatusListener listener){
