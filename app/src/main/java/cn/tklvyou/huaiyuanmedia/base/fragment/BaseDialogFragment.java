 ...
 * @param <T>
 */
public abstract class BaseDialogFragment<T extends BaseContract.BasePresenter> extends RxDialogFragment implements BaseContract.BaseView, LazyFragmentControl {
