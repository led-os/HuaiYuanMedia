package cn.tklvyou.huaiyuanmedia.ui.video_edit.record.encoder;
...
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.encoder.gles.EglCore;
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.BaseFilter;
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.NoneFilter;
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.gpuFilters.baseFilter.GPUImageFilter;
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.gpuFilters.baseFilter.MagicCameraInputFilter;
...
public class TextureMovieEncoder implements Runnable {
        ...
        private CameraView.OnReleaseStatusListener onReleaseStatusListener;
         ...
         * has completed).
         * @param onReleaseStatusListener
         */
        public void stopRecording(CameraView.OnReleaseStatusListener onReleaseStatusListener) {
            this.onReleaseStatusListener = onReleaseStatusListener;
...
//            type = MagicFilterType.NONE;
            ...
            if(onReleaseStatusListener != null){
                onReleaseStatusListener.releaseSuccess();
            }

        }
        //    private MagicFilterType type = MagicFilterType.NONE;
        private BaseFilter mShowFilter=new NoneFilter(MyApplication.getAppContext().getResources());
