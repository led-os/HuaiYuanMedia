package cn.tklvyou.huaiyuanmedia.ui.video_edit.record.pop;
...
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.ui.ThumbnailCountDownTimeView;
...
public class PopupManager {
    ...
    public void showCountDown(Resources res, int mStartTime, final SelTimeBackListener pop) {
        ...
        final PopupWindow mShowCountDownPW = new PopupWindow(showCountDown.getRootView(), ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        int min = mStartTime * (MyApplication.screenWidth - (int) res.getDimension(R.dimen.dp_20)) / 30;
        selTimeTv.layout(min, 0, selTimeTv.getHeight(), selTimeTv.getWidth());
        selTimeTv.setTranslationX((MyApplication.screenWidth - (int) res.getDimension(R.dimen.dp_40)));
