package cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.gpuFilters.utils;
...
public class OpenGlUtils {
	...
	public static String readShaderFromRawResource(final int resourceId){
		final InputStream inputStream = MyApplication.getAppContext().getResources().openRawResource(
				resourceId);
