package cn.tklvyou.huaiyuanmedia.ui.video_edit.record.draw;
...
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.encoder.TextureMovieEncoder;
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.BaseFilter;
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.CameraDrawProcessFilter;
import cn.tklvyou.huaiyuanmedia.ui.video_edit.record.filters.CameraFilter;
...
//            videoEncoder.setTextureId(fTexture[0]);
    ...
    private void recording() {
        if (recordingEnabled){
            ...
            switch (recordingStatus) {
                ...
                case RECORDING_RESUME:
                case RECORDING_PAUSED:
                    videoEncoder.stopRecording(onReleaseStatusListener);
                    recordingStatus = RECORDING_OFF;
                    break;
                case RECORDING_OFF:
                    break;
    ...
    public void stopRecord(CameraView.OnReleaseStatusListener listener) {
        recordingEnabled=false;
        this.onReleaseStatusListener = listener;
    }
