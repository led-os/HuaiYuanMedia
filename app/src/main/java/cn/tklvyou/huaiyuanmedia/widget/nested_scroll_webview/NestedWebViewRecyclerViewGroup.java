...
public class NestedWebViewRecyclerViewGroup extends ViewGroup implements NestedScrollingParent2 {
    ...
    public NestedWebViewRecyclerViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (scrollbarEnable) {
            ...
            float space = array.getDimension(R.styleable.NestedWebViewRecyclerViewGroup_scrollbarMarginRight, ConvertUtils.dp2px(3));
            float barWidth = array.getDimension(R.styleable.NestedWebViewRecyclerViewGroup_scrollbarWidth, ConvertUtils.dp2px(4));
            float barMinHeight = array.getDimension(R.styleable.NestedWebViewRecyclerViewGroup_scrollbarMinHeight, ConvertUtils.dp2px(30));
