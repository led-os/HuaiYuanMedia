package cn.tklvyou.huaiyuanmedia.widget;
...
public class FrameLayout4Loading extends FrameLayout {
    ...
    public FrameLayout4Loading(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void doShowNoData() {
        doShowNoData(null, null, null, null);
    }
    ...
    public void doShowNoData(Drawable background, String msg, String btnTxt, OnClickListener click) {
        ...
        if (view == null || click != null) {
            ...
            try {
                ...
                if (msg != null) {
                    TextView empText = view.findViewById(R.id.empty_tip_tv);
                    empText.setText(msg);
                }


                if (click != null) {
                    TextView empty_btn = view.findViewById(R.id.empty_btn);
    ...
    public void showNoNetView(int backgroundId) {
        showNoNetView(getResources().getDrawable(backgroundId));
    }

    public void showNoNetView(Drawable background) {
        showView(ViewType_NoNetwork, background);
    }
    ...
    private void doShowView(int viewType, Drawable background) {
        ...
        if (view == null) {
            view = mInflater.inflate(resLayoutId, null);
            try {
                TextView errorText = view.findViewById(R.id.loading_error_text);
    ...
    private void initView(View v, int viewType) {
        ...
        if (ViewType_EmptyView == viewType) {
            ...
            AnimationDrawable frameAnim = (AnimationDrawable) mContext.getResources().getDrawable(R.drawable.anim_loading);
