...
public class CopyMultiImageView extends LinearLayout {
    ...
    public CopyMultiImageView(Context context) {
        super(context);
    }

    public CopyMultiImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
