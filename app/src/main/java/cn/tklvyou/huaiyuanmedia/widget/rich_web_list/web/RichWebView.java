...
public class RichWebView extends BaseWebView {
    ...
    public interface AfterInitialLoadListener {
        ...
        void onAfterInitialLoad(boolean isReady, WebView view);
    }
...
//    setWebChromeClient(new WebChromeClient());
    ...
    public void setCustomJsMethod(String method){
        exec(method);
    }
    ...
    private String JS_CALL_ANDROID_METHOD = "jsCallAndroid";
    protected class EditorWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (mLoadListener != null) {
                mLoadListener.onAfterInitialLoad(isReady, view);
            }
        }
