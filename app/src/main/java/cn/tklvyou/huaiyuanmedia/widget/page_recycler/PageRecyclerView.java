package cn.tklvyou.huaiyuanmedia.widget.page_recycler;
 ...
 * </p>
 * <p>
 * 默认为1行，每页4列，如果要自定义行数和列数，请在调用{@link PageRecyclerView#setAdapter(Adapter)}方法前调用
...
public class PageRecyclerView extends RecyclerView {
    ...
    private int defaultDividerWidth = 20;
    ...
    private void defaultInit(Context context) {
        ...
        setLayoutManager(new AutoGridLayoutManager(mContext, spanRow, GridLayoutManager.HORIZONTAL, false));
    ...
    public void onScrollStateChanged(int state) {
        switch (state) {
            ...
            case 1:
                ...
                break;
            case 0:
                LogUtils.e("first:" + slideDistance);
                if (slideDistance == 0) {
                    break;
                }
                scrollState = 0;
...
//                itemWidth = withScreen / 6;
                if (itemWidth <= 0) {
                    itemWidth = ScreenUtils.getScreenWidth() / spanColumn;
                }
