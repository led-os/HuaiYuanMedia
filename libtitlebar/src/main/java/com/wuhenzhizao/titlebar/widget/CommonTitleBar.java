 ...
 * <attr name="centerDrawable" format="reference" /> <!-- TextView 左边图片, 对应centerType_TextView -->
 * <attr name="centerDrawablePadding" format="dimension" /> <!-- TextView 左边padding, 对应centerType_TextView -->
...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private int centerDrawable;                         // 中间TextView drawableLeft资源
    private float centerDrawablePadding;                // 中间TextView drawablePadding
    ...
    private static final int TYPE_DARK_MODE = 0;
    private static final int TYPE_LIGHT_MODE = 1;
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerDrawable = array.getResourceId(R.styleable.CommonTitleBar_centerDrawable, 0);
            centerDrawablePadding = array.getDimension(R.styleable.CommonTitleBar_centerDrawablePadding, 5);
    ...
    private void initMainCenterViews(Context context) {
        if (llMainCenter != null) {
            rlMain.removeView(llMainCenter);
            llMainCenter = null;
        }

        if (rlMainCenterSearch != null) {
            rlMain.removeView(rlMainCenterSearch);
    ...
    private void setUpImmersionTitleBar() {
        ...
        // 设置图标主题
        if (statusBarMode == TYPE_DARK_MODE) {
...
//            }
     ...
     */
    public void setLeftContent(int type, String leftText, int leftDrawable, int leftImageResource, int leftCustomViewRes) {
        this.leftType = type;

        switch (type) {
            case CommonTitleBar.TYPE_LEFT_NONE:

                break;
            case CommonTitleBar.TYPE_LEFT_TEXTVIEW:
            ...
            case CommonTitleBar.TYPE_LEFT_IMAGEBUTTON:
                ...
                break;
            case CommonTitleBar.TYPE_LEFT_CUSTOM_VIEW:
    ...
    public void setRightContent(int type, String rightText, int rightImageResource, int rightCustomViewRes) {
        ...
        switch (type) {
            case CommonTitleBar.TYPE_RIGHT_NONE:

                break;
            case CommonTitleBar.TYPE_RIGHT_TEXTVIEW:
                this.rightText = rightText;
                break;
            case CommonTitleBar.TYPE_RIGHT_IMAGEBUTTON:
                if (rightImageResource != 0) {
                    this.rightImageResource = rightImageResource;
                }
                break;
            case CommonTitleBar.TYPE_RIGHT_CUSTOM_VIEW:
    ...
    public void setCenterContent(int type, String centerText, String centerSubText, int centerDrawable, int centerSearchBgResource, int centerCustomViewRes) {
        ...
        switch (type) {
            case CommonTitleBar.TYPE_CENTER_NONE:

                break;
            case CommonTitleBar.TYPE_CENTER_TEXTVIEW:
                this.centerText = centerText;
                this.centerSubText = centerSubText;
                this.centerTextMarquee = true;
                if (centerDrawable != 0) {
                    this.centerTextMarquee = false;
                    this.centerDrawable = centerDrawable;
                }

                break;
            case CommonTitleBar.TYPE_CENTER_SEARCHVIEW:
                this.centerSearchRightType = TYPE_CENTER_SEARCH_RIGHT_DELETE;
                this.centerSearchEditable = true;
                ...
                break;
            case CommonTitleBar.TYPE_CENTER_CUSTOM_VIEW:
                if (centerCustomViewRes != 0) {
    ...
    public void toggleStatusBarMode() {
        ...
        StatusBarUtils.transparentStatusBar(window);
        if (statusBarMode == TYPE_DARK_MODE) {
            statusBarMode = TYPE_LIGHT_MODE;
            StatusBarUtils.setLightMode(window);
        } else {
            statusBarMode = TYPE_DARK_MODE;
            StatusBarUtils.setDarkMode(window);
        }
    }
